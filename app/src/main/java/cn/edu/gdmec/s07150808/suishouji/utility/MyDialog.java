package cn.edu.gdmec.s07150808.suishouji.utility;
...
import cn.edu.gdmec.s07150808.suishouji.R;
...
public class MyDialog {
	...
	public static void getAlertDialog(Activity context,String title,String message){
		alertDialog = new AlertDialog.Builder(context).setTitle(title)
			.setMessage(message)
			.setPositiveButton(context.getString(R.string.exit_ok), new OnClickListener() {
			@Override
