...
//		transfer_out_account_spn.setp
	...
	private void save(){
		...
		if (TextUtils.isEmpty(transfer_amount_out_et.getText().toString())) {
			Toast.makeText(getApplicationContext(), getString(R.string.transfer_amount_empty), Toast.LENGTH_SHORT).show();
			return;
		}
		...
		try {
			...
			Toast.makeText(getApplicationContext(), getString(R.string.transfer_amount_number), Toast.LENGTH_SHORT).show();
			return;
		}
		if(transfer_amount == 0){
			Toast.makeText(getApplicationContext(),getString(R.string.transfer_amount_0), Toast.LENGTH_SHORT).show();
			return;
		}
