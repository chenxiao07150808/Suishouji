...
import cn.edu.gdmec.s07150808.suishouji.db.MyDbHelper;
import cn.edu.gdmec.s07150808.suishouji.db.MyDbInfo;
					...
					if (which == 0) {
						...
						builder.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								Toast.makeText(nav, getString(R.string.message_delete_ok), Toast.LENGTH_LONG).show();
							}
						});
